...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_PapersDB = QtWidgets.QAction(MainWindow)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/PIC/报纸.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_PapersDB.setIcon(icon13)
        self.action_PapersDB.setObjectName("action_PapersDB")
        ...
        self.toolBar.addAction(self.action_PapersDB)
        self.toolBar.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_home.setToolTip(_translate("MainWindow", "数据库简介"))
        self.action_close.setText(_translate("MainWindow", "关闭"))
        self.action_close.setToolTip(_translate("MainWindow", "关闭所有页面"))
        ...
        self.action_historyDB.setToolTip(_translate("MainWindow", "历史文献库"))
        ...
        self.action_institutionDB.setToolTip(_translate("MainWindow", "研究机构库"))
        self.action_expertDB.setText(_translate("MainWindow", "专家学者库"))
        self.action_expertDB.setToolTip(_translate("MainWindow", "专家学者库"))
        ...
        self.Action_meetDB.setToolTip(_translate("MainWindow", "会议论文库"))
        self.action_PeriodicalDB.setText(_translate("MainWindow", "期刊库"))
        self.action_PeriodicalDB.setToolTip(_translate("MainWindow", "期刊库"))
        self.action_BookDB.setText(_translate("MainWindow", "图书库"))
        self.action_BookDB.setToolTip(_translate("MainWindow", "图书库"))
        self.action_ThesisDB.setText(_translate("MainWindow", "学位论文库"))
        self.action_ThesisDB.setToolTip(_translate("MainWindow", "学位论文库"))
        self.action_PapersDB.setText(_translate("MainWindow", "报刊资料库"))
        self.action_PapersDB.setToolTip(_translate("MainWindow", "报刊资料库"))
import RES.img_rc
