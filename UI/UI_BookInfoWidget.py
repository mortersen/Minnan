...
# Form implementation generated from reading ui file 'UI_BookInfoWidget.ui'
#
...
class Ui_BookInfoView(object):
    def setupUi(self, BookInfoView):
        BookInfoView.setObjectName("BookInfoView")
        BookInfoView.resize(486, 593)
        BookInfoView.setMinimumSize(QtCore.QSize(48, 48))
        BookInfoView.setAutoFillBackground(False)
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(BookInfoView)
        ...
        self.btn_pdfRead = QtWidgets.QPushButton(BookInfoView)
        ...
        self.btn_pdfDownload = QtWidgets.QPushButton(BookInfoView)
        ...
        self.label_Title = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        ...
        self.label_Author = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        ...
        self.label_SeriesName = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_Summary = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_2 = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_Keyword = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_3 = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_Press = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_4 = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_Category = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_ = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_Volume = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_5 = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_Ce = QtWidgets.QLabel(BookInfoView)
        ...
        self.label_6 = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_Pages = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_11 = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_PubDate = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_12 = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_FL = QtWidgets.QLabel(BookInfoView)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.retranslateUi(BookInfoView)
        QtCore.QMetaObject.connectSlotsByName(BookInfoView)

    def retranslateUi(self, BookInfoView):
        _translate = QtCore.QCoreApplication.translate
        BookInfoView.setWindowTitle(_translate("BookInfoView", "Form"))
        self.label_Title.setText(_translate("BookInfoView", "我是标题"))
        self.label.setText(_translate("BookInfoView", "摘要："))
        self.label_2.setText(_translate("BookInfoView", "主题词："))
        self.label_3.setText(_translate("BookInfoView", "出版社："))
        self.label_4.setText(_translate("BookInfoView", "部类："))
        self.label_.setText(_translate("BookInfoView", "卷数："))
        self.label_5.setText(_translate("BookInfoView", "册："))
        self.label_6.setText(_translate("BookInfoView", "页码："))
        self.label_11.setText(_translate("BookInfoView", "出版日期："))
        self.label_12.setText(_translate("BookInfoView", "分类："))
import RES.img_rc
...
if __name__ == "__main__":
    ...
    BookInfoView = QtWidgets.QWidget()
    ui = Ui_BookInfoView()
    ui.setupUi(BookInfoView)
    BookInfoView.show()
    sys.exit(app.exec_())
